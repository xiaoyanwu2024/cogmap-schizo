...
% DrawImageNoStretch  Draw an image without distortion, keep aspect ratio, auto-center
%
% Usage:
...
% Compute scaling factors to keep aspect ratio
scaleX = screenXpixels / imgWidth;
scaleY = screenYpixels / imgHeight;
scaleFactor = min(scaleX, scaleY);  % Use the smaller scale
