...
function orderTaskImage(subID, dayLabel)
try
    % clear;clc;
    ...
    taskConfig.Age.questionText = {'Who is OLDER?', 'Who is YOUNGER?'};
    taskConfig.Age.questionType = {'older', 'younger'};

    taskConfig.Time.labels = {'dawn', 'morning', 'noon', 'afternoon', 'sunset', 'evening', 'night'};
