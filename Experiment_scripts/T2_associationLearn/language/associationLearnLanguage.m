function associationLearnLanguage(subid, day)
try
    %% initialization
    % clear; clc; close all;
    ...
    minRepeats = 3;
    testRepeats = 2;
    consecutiveCorrectRequired = 12 - 1; % Minimum 10 correct out of 12
    ...
    while trialIndex <= size(learningTrials, 1)
        ...
        t_ageText = learningTrials{trialIndex, 6};
        t_time = learningTrials{trialIndex, 2};
        t_timeText = learningTrials{trialIndex, 7};
        ...
        while retry
            checkForEscape();
            trialNum = trialNum + 1;
            [choice, rt] = presentTrial(win, instrDir, t_ageText, t_timeText, shuffledFoodNames, xCenter, yCenter);
    ...
    while true
        ...
        t_ageText = testTrialList{testTrialIndex, 6};
        t_time = testTrialList{testTrialIndex, 2};
        t_timeText = testTrialList{testTrialIndex, 7};
